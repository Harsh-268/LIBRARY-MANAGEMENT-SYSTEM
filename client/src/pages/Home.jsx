...
// import BookCard from '../components/cards/Bookcards.jsx'; // will use this later
    ...
    <div className="flex flex-col items-center">
      ...
      <section className="w-full bg-gray-900 text-white py-20 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            Explore thousands of books across all genres. From thrilling mysteries to heartwarming romance, your digital library awaits.
          </p>
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">Popular Genres</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['Fiction', 'Sci-Fi', 'Mystery', 'Biography'].map((genre, index) => (
              <div 
                key={index} 
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-500 mb-10">Our community's current favorites.</p>
          
          <div className="flex flex-wrap justify-center gap-6">
            {/* Later, you will fetch 3-4 books from your API here 
              and map over them returning <BookCard /> components!
            */}
            <div className="w-full max-w-sm bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-gray-400 italic">
